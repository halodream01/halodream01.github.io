...
document.addEventListener('DOMContentLoaded', () => {
    ...
    (() => {
        ...
        function init() {
            ...
            if (window.innerWidth <= 768) {
                particleSystem.position.x = 0;   // 【新】手机上，水平居中
                particleSystem.position.y = -6; // 手机上，垂直下移
            } else {
                particleSystem.position.x = 9;   // 桌面端，保持向右偏移
                particleSystem.position.y = 0;   // 桌面端，保持垂直居中
            }
        ...
        function onWindowResize() {
            ...
            if (window.innerWidth <= 768) {
                ...
                particleSystem.position.x = 9;   // 桌面端，恢复向右偏移
                particleSystem.position.y = 0;   // 桌面端，恢复垂直居中
            }
        }
    ...
    /**
     * ------------------------------------------------------------------------
     * PART 2: FAQ Accordion Functionality (No Change)
     * ------------------------------------------------------------------------
     */
    (() => {
        ...
        faqItems.forEach(item => {
            const questionWrapper = item.querySelector('.q-bubble-wrapper');
            if (questionWrapper) {
    ...
    (() => {
        ...
        const config = {
            ...
            maxBrightness: 0.05, // 新增参数：控制最大亮度
            changeThreshold: 0.99 // 新增参数: 控制形状变化的随机阈值
        };
        // ---
